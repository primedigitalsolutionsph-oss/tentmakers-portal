...
export const ventures: Venture[] = [
  {
    ...
    offering: 'Website and app development plus business automation — affordable, branded online presence that turns foot traffic into digital traffic.',
    marketSignals: [
    ...
    description: 'An established web and app development business — the technology backbone of the ecosystem, building and hosting the Tentmakers platform with discounted dev services for member founders.',
    fullDescription: [
  ...
  },
  {
    ...
    offering: 'A smart savings membership — QR-code deals and cashback at partner merchants, and a day-one perk of Tentmakers membership.',
    marketSignals: [
    ...
    description: 'Thrifty Tribe is a smart savings membership built on QR-code deals and cashback: members save on everyday spending while member businesses become partner-merchants.',
    fullDescription: [
  ...
  },
  {
    ...
    description: 'ICKY combines insurance literacy, road-safety education, 3D driving simulation, and 24/7 SOS — with discounted plans for members and their riders.',
    fullDescription: [
  ...
  },
  {
    ...
    description: 'Prime Axis is a labor marketplace for skilled and general talent — staffing network events now, and growing into the hiring resource for members’ businesses.',
    fullDescription: [
  ...
  },
  {
    ...
    stage: 'Early',
    gap: 'The Trust Gap',
    offering: 'A founder community launching across Panay Island — Founder Circles, a 12-week accelerator, and Demo Day, targeting 300 members by Q4 2026.',
    marketSignals: [
    ...
    description: 'Tentmakers Network is a pre-launch founder community — the front door to four working ventures, starting with Founder Circles and a 12-week accelerator ending in Demo Day.',
    fullDescription: [
