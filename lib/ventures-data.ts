...
// The MySQL ventures table (db/hostinger.sql) mirrors this file field-for-field
// for future CMS use. Until pages read from the database, edit HERE — then
// mirror the change into db/hostinger.sql to keep both sources consistent.
...
export const ventures: Venture[] = [
  ...
  },
  {
    ...
    offering: 'Insurance literacy, road-safety education, 3D driving simulation, and 24/7 SOS — with discounted plans for members and their riders.',
    marketSignals: [
  ...
  },
  {
    ...
    stage: 'Early',
    gap: 'The Trust Gap',
    offering: 'A member network launching across Panay Island — three training tiers, mentorship, and real company access, targeting 300 members by Q4 2026.',
    marketSignals: [
      '300-member target: Iloilo HQ 150, Capiz 60, Aklan 50, Antique 40',
      'Three training tiers: Tier 1 Foundation, Tier 2 Building, Tier 3 Established — plus Anchor band for mentor-track candidates',
      'Readiness Score blends training, savings, site engagement, protection, and mentorship',
    ],
    description: 'The connective tissue across all companies — a member network with a Readiness Score, three training tiers, and real company access, not a franchise offer.',
    fullDescription: [
      ...
      'Members progress through three training tiers — Tier 1 Foundation, Tier 2 Building, Tier 3 Established — with an Anchor band (90–100) flagging mentor-track candidates. The Readiness Score blends training completion, savings consistency, site engagement, protection enrollment, and mentorship participation so advancement reflects real readiness, not course-clicking alone.',
      'Tiers are strictly readiness gates, not a ladder toward a Tentmakers role. A member can complete all three tiers and never engage with the companies again — that\'s a successful outcome, not an attrition problem.',
    ],
    metric: '300',
...
export const networkLayout: {
  ...
  satellites: [
    ...
    { slug: 'prime-axis', name: 'Prime Axis', x: 60, y: 180, gap: 'The Staffing Gap', metric: '41%' },
    { slug: 'icky', name: 'ICKY', x: 180, y: 180, gap: 'The Protection Gap', metric: '~1.79%' },
  ],
  colors: {
