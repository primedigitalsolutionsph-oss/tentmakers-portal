...
VALUES
  ...
  ('thrifty-tribe','Thrifty Tribe','Early','The Discount Gap',
   'QR-code deals and cashback savings membership.',
   'Smart savings membership; day-one Tentmakers perk.',
  ...
  ('tentmakers-network','Tentmakers Network','Early','The Trust Gap',
   'Founder community across Panay Island.',
   'Front door to four working ventures; 300-member Q4 2026 target.',
   JSON_ARRAY('300-member target: Iloilo HQ 150, Capiz 60, Aklan 50, Antique 40','Two tiers: membership + accelerator'),
   JSON_ARRAY('Two-tier model: open membership plus accelerator cohorts.'),
   '300','member target by Q4 2026',
   JSON_ARRAY('Community','Accelerator','Training'));
